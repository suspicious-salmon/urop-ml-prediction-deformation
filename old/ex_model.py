...
class UNet(nn.Module):
    def __init__(self, in_dim, do_output_sigmoid=True, do_batchnorm=False, do_layernorm=False):
        ...
        # -------
        self.e11 = nn.Conv2d(1, 64, kernel_size=3, padding=1, bias=True) # output: [N, 64, H, W]
        self.e12 = nn.Conv2d(64, 64, kernel_size=3, padding=1, bias=do_batchnorm) # output: [N, 64, H, W]
        self.bn1 = torch.nn.BatchNorm2d(64)
        self.ln1 = torch.nn.LayerNorm((64, *in_dim))
        ...
        self.ln2 = torch.nn.LayerNorm((128, in_dim[0]//2, in_dim[1]//2))
        ...
        self.ln3 = torch.nn.LayerNorm((256, in_dim[0]//4, in_dim[1]//4))
        ...
        self.ln4 = torch.nn.LayerNorm((512, in_dim[0]//8, in_dim[1]//8))
        ...
        self.ln5 = torch.nn.LayerNorm((1024, in_dim[0]//16, in_dim[1]//16))

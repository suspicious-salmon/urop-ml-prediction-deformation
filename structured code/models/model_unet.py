...
class UNet(nn.Module):
    def __init__(self, in_dim, do_output_sigmoid=True, do_batchnorm=False, do_layernorm=False):
        ...
        self.ln2 = torch.nn.LayerNorm((128, in_dim//2, in_dim//2))
        ...
        self.ln3 = torch.nn.LayerNorm((256, in_dim//4, in_dim//4))
        ...
        self.ln4 = torch.nn.LayerNorm((512, in_dim//8, in_dim//8))
        ...
        self.ln5 = torch.nn.LayerNorm((1024, in_dim//16, in_dim//16))
